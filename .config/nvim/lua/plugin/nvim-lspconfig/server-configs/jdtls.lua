...
function M.setup()
  local config = {
    cmd = {
      ...
      '-jar',
      '/Users/juanedflores/tools/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
      '-configuration',
      '/Users/juanedflores/tools/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_mac',
      '-data',
      '/Users/juanedflores/eclipse-workspace/',
    },
    settings = {
      java = {
        configuration = {
